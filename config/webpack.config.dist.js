...
module.exports = {
  ...
  resolve: {
    ...
    alias: {
      ...
      'react-fw-react': path.resolve(__dirname, '../node_modules/react-fw-react'),
  ...
  externals: {
    ...
    'ringa-fw-react': {
      root: 'Ringa FW React',
      commonjs2: 'ringa-fw-react',
      commonjs: 'ringa-fw-react',
      amd: 'ringa-fw-react',
      umd: 'ringa-fw-react',
    },
    'moment': {
  ...
  output: {
    ...
    filename: `${configVars.artifactRoot}.min.js`,
    publicPath: '/',
    library: configVars.name,
    libraryTarget: 'umd'
  },
  plugins: [
